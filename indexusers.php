...
<div class="header" id="home">
	<div class="container">
	             <?php
				 $ss=$_SESSION['user'];
				 echo( '<div style="float:right;text-align:center;"><h5 style="color:white"><b> Welcome : </b></h5>'.'<h4 style="color:white">'.$ss.'</h4></div>');
                ?>
		<ul>
		   <li> <a href="cookie.php" data-toggle="" data-target="" tabindex="-1" ><i class="fa fa-unlock-alt" aria-hidden="true"></i> Sign out </a></li>
			<li > <a href="editprofile.php" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit Profile </a></li>
			<li> <a href="Unsubscribe.php"  ><i class="fa fa-unlock-alt" aria-hidden="true"></i> Unsubscribe </a></li>
			<li style="display: contents;width: 21.5%"> <a href="payment.php"><i class="fa fa-gift" aria-hidden="true"></i> Order </a></li>
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class=" menu__item"><a class="menu__link" href="myorders.php">My Orders</a></li>
				  </ul>
				</div>
			  </div>
			</nav>	
					...
					<div class="modal-header">
						...
						<h3 class="agileinfo_sign">Sign Up <span>Now</span></h3>
						 <form action="#" method="post">
							...
							<div class="styled-input">
								<input type="text" name="txtSecurityQuestion" required=""> 
								<label>Security Question</label>
								<span></span>
							</div>
							<div class="styled-input">
								<input type="text" name="txtSecurityAnswer" required=""> 
...
<!-- //schedule-bottom -->
  ...
  <div class="banner-bootom-w3-agileits">
	<div class="container">
		<h3 class="wthree_text_info"> Our <span>Sections</span></h3>
		<?php
              ...
              while($row=mysqli_fetch_assoc($qry))
               {
            ?>
		<div class="col-md-6 bb-grids bb-middle-agileits-w3layouts" style="margin-bottom: 20px;">
		      <a href="itemsbefore.php?secno=<?php echo($row['SectionNo']);?>" >
		       <div class="bb-middle-agileits-w3layouts grid">
			           <figure class="effect-roxy">
							<img src="Section/<?php echo($row['SectionNo']);?>.jpg" alt=" " class="img-responsive" />
							<figcaption>
...
<div class="footer">
	<div class="footer_agile_inner_info_w3l">
		<div class="col-md-3 footer-left">
			<h2><a href="index.php"><span>M</span>riam Shoppy </a></h2>
